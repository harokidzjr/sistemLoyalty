...
<?php echo $form->datePickerGroup($model, 'tgl_lahir', array('widgetOptions' => array('options' => array('format' => 'yyyy-mm-dd'), 'htmlOptions' => array('class' => 'span5')), 'prepend' => '<i class="fa fa-calendar"></i>', 'append' => 'Click on Month/Year to select a different Month/Year.')); ?>
...
<?php
echo $form->fileFieldGroup($model, 'scan_ktp', array(
