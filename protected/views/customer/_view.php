<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('jumlah_point')); ?>:</b>
	<?php echo CHtml::encode($data->jumlah_point); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('scan_ktp')); ?>:</b>
	<?php echo CHtml::encode($data->scan_ktp); ?>
	<br />
