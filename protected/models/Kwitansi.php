...
class Kwitansi extends CActiveRecord {
    ...
    public function getResi() {
        return $this->no_resi . ' | ' . $this->idTenant->nama_toko . ' | ' . $this->idCustomer->nama . '/' . $this->idCustomer->no_ktp;
    }

    public function afterFind() {
        $this->id_konversi = $this->idKonversi->konversi;
        $this->id_tenant = $this->idTenant->nama_toko;
